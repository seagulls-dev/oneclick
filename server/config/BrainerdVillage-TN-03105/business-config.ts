...
export var BusinessConfig: Config = {
  client: {
    ...
    minShiftLengthForLongBreakHours: 10,
    ...
    leadershipProgression: [
      ...
      { role: 'trainer',          title: 'Coordinator' },
      { role: 'teamLeader',       title: 'Area Leader' },
  ...
  server: {
    ...
    HotSchedules: {
      adminUsername: "natemackey",
      adminPassword: "Nm1145951",
    ...
    storeEmployeeEmail: "catering@cfabrainerdvillage.com", // Optional store email for logging in as Da Cowz

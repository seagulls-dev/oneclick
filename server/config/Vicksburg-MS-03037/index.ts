...
const containedBusinessConfig: ContainedBusinessConfig = {
  skip: false,
  businessId: "vicksburgd54d68d2d8",
  document: {
    configUpdated: new Date,
    info: {
      name: "CFA Vicksburg, MS #03037",
      storeNumber: "03037",
      address: "3403 Halls Ferry Rd, Vicksburg, MS 39180"
    },
    destinationInfo: [
      {
        abbreviation: "FOH",
    ...
    autoUpdate: new Date("2020-10-29T23:59:59-06:00"),
    useTraining: new Date("2020-10-29T23:59:59-06:00"),
